...
class SharedPreferences {
  ...
  static Future<Future<SharedPreferences>?> getInstance() async {
    if (_completer == null) {
  ...
  /// bool.
  Object? getBool(String key) => _preferenceCache[key];

  /// Reads a value from persistent storage, throwing an exception if it's not
  /// an int.
  Object? getInt(String key) => _preferenceCache[key];

  /// Reads a value from persistent storage, throwing an exception if it's not a
  /// double.
  Object? getDouble(String key) => _preferenceCache[key];

  /// Reads a value from persistent storage, throwing an exception if it's not a
  /// String.
  Object? getString(String key) => _preferenceCache[key];
  ...
  List<Object>? getStringList(String key) {
