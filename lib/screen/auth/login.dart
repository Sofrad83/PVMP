...
import 'package:pvmp/bloc/cubit/login_cubit.dart';
...
class Login extends StatelessWidget {
  ...
  void callLogin(LoginCubit loginCubit) async {
    bool isValid = mainform.currentState!.validate();
    if (isValid) {
      await loginCubit.login(emailController.text, mdpController.text);
    }
  }
