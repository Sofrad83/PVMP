...
class _RegisterState extends State<Register>{
  ...
  void callRegister(BuildContext context) async{
    ...
    if(isValid){
      ...
      context.read<ConnexionCubit>().register(name!, email!, mdp!);
    }
  }
      ...
      builder: (context, state) {
        ...
        if(state is ConnexionLoadedState){
          if(state.connexion != null){
            WidgetsBinding.instance.addPostFrameCallback((_) {
              Flushbar(
                messageText: Text("Votre compte a bien été créé", style: FlutterFlowTheme.of(context).bodyMedium,),
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () => callRegister(context),
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () => Navigator.of(context).pushNamedAndRemoveUntil(Login.routeName, (route) => false),
